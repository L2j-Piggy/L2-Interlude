...
import handlers.admincommandhandlers.AdminNpcSearchServer;
...
import handlers.admincommandhandlers.AdminSkillSearchServer;
...
public class MasterHandler
{
	...
	private static final Class<?>[][] HANDLERS =
	{
		...
		},
		{
			...
			AdminRes.class,
			AdminRide.class,
			AdminNpcSearchServer.class,
			AdminScan.class,
			AdminSearch.class,
			AdminServerInfo.class,
			AdminSkillSearchServer.class,
			AdminShop.class,
